...
Book 是一个 [KOReader](https://koreader.rocks/) 插件，为 KOReader 提供连接远端 Book 服务的书库桌面。它将图书馆、主页、统计和设置整合为全屏界面，可下载并打开书籍、缓存封面，以及同步阅读进度。
...
1. 在 **主页** 查看最近阅读和在读书籍，或切换到 **图书馆** 浏览全部藏书；**统计** 页直接从服务器拉取多维阅读数据。
